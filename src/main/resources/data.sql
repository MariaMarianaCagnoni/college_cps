-- Cria professores
INSERT INTO professor (ativo, data_cadastro, nome)
VALUES (true, now(), 'Professor 1');
INSERT INTO professor (ativo, data_cadastro, nome)
VALUES (true, now(), 'Professor 2');
INSERT INTO professor (ativo, data_cadastro, nome)
VALUES (true, now(), 'Professor 3');
INSERT INTO professor (ativo, data_cadastro, nome)
VALUES (true, now(), 'Professor 4');

-- Cria cursos
INSERT INTO curso (carga_horaria, categoria, data_cadastro, descricao, nome, professor_id)
VALUES (40, 'Software', now(), 'Desenvolvimento de aplicações web em Java', 'Java Web', 1);
INSERT INTO curso (carga_horaria, categoria, data_cadastro, descricao, nome, professor_id)
VALUES (40, 'Software', now(), 'Desenvolvimento de aplicações web com Spring Boot', 'Java Web com Spring Boot', 2);
INSERT INTO curso (carga_horaria, categoria, data_cadastro, descricao, nome, professor_id)
